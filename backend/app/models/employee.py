...
class Employee(Base):
    ...
    assess_type = Column(String(20), nullable=False, comment="考核类型：基层管理人员/公共人员/业务人员/产品研发人员")
    assess_type_secondary = Column(String(20), nullable=True, comment="第二考核类型（混合角色）")
